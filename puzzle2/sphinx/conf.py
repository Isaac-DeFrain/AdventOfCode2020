...
# -*- coding: utf-8 -*-
#
# puzzle2 documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'puzzle2'
copyright = 'Isaac-DeFrain <isaacdefrain@gmail.com>'
author = 'Isaac-DeFrain <isaacdefrain@gmail.com>'
...
latex_documents = [
    (master_doc, 'puzzle2.tex', 'puzzle2 Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'puzzle2', 'puzzle2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'puzzle2', 'puzzle2 Documentation',
     author, 'puzzle2', 'One line description of project.',
     'Miscellaneous'),
]
