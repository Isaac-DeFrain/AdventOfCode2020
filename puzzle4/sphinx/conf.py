...
# -*- coding: utf-8 -*-
#
# puzzle4 documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'puzzle4.tex', 'puzzle4 Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'puzzle4', 'puzzle4 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'puzzle4', 'puzzle4 Documentation',
     author, 'puzzle4', 'One line description of project.',
     'Miscellaneous'),
]
