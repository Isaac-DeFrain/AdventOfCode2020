...
# -*- coding: utf-8 -*-
#
# puzzle9 documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'puzzle9.tex', 'puzzle9 Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'puzzle9', 'puzzle9 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'puzzle9', 'puzzle9 Documentation',
     author, 'puzzle9', 'One line description of project.',
     'Miscellaneous'),
]
