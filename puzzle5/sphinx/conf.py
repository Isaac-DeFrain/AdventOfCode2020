...
# -*- coding: utf-8 -*-
#
# puzzle5 documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'puzzle5.tex', 'puzzle5 Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'puzzle5', 'puzzle5 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'puzzle5', 'puzzle5 Documentation',
     author, 'puzzle5', 'One line description of project.',
     'Miscellaneous'),
]
