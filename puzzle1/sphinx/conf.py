...
# -*- coding: utf-8 -*-
#
# puzzle1 documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'puzzle1.tex', 'puzzle1 Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'puzzle1', 'puzzle1 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'puzzle1', 'puzzle1 Documentation',
     author, 'puzzle1', 'One line description of project.',
     'Miscellaneous'),
]
