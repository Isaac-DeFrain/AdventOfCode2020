...
# -*- coding: utf-8 -*-
#
# puzzle3 documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'puzzle3.tex', 'puzzle3 Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'puzzle3', 'puzzle3 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'puzzle3', 'puzzle3 Documentation',
     author, 'puzzle3', 'One line description of project.',
     'Miscellaneous'),
]
